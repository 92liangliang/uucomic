...
public class BookCellRaking extends BaseRvCell<BookBean> {

    private boolean isGrid = false;

    public BookCellRaking(BookBean bookBean) {
        super(bookBean);
    }
    ...
    public BaseRvViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cell_book_ranking, parent, false);
        if (isGrid) {
...
//        TextView tvRecentWords = holder.getTextView(R.id.tv_recentWords_cell_book_home);
        ...
        tvName.setText(position+1 +". "+mData.getBook_name());
//        tvScore.setText(mData.getStart());

...
import kotlinx.android.synthetic.main.list_item_recharge_money.view.*

class RechargeMoneyAdapter(val context: Context, val dataList: List<RechargeMoney>) : RecyclerView.Adapter<RechargeMoneyAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.list_item_recharge_money, parent, false)
        viewList.add(view.findViewById<RelativeLayout>(R.id.rl_container))

...
class AreaAdapter(
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bindData(data: AreaBean) {
            itemView.tv_name_cell_type.text = "${data.area_name}"
            if (data.click) {
                selected = data
